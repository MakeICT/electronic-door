...
(function() {
  ...
  Alarm = (function(superClass) {
    ...
    Alarm.prototype.handlePanelData = function(msg) {
      var armedAway, armedStay, beeps, disarmed, parts, sec, sec1, sec2, sections;
      parts = msg.split(',');
      sections = [];
    ...
    Alarm.connect = function() {
      ...
      socket.on('error', function(error){
        if(Alarm.errorHandler){
          Alarm.errorHandler(error);
        }else{
          console.log(error);
        }
      });
